...
int main(void)
{
    ...
    myQueue = (Queue*)Mymalloc(sizeof (Queue));
    initializeStack(&myStack->head);
    initializeQueue(&myQueue->head,&myQueue->tail);
